		...
		<div class="container-login100" style="background-image: url('../images/img-01.jpg');">
			<div class="wrap-login100 p-t-190 p-b-250">
				...
				<div class="container-login100-form-btn p-t-10">
					<button onclick="window.location.href='rules.php'" class="login100-form-btn">
						Rules
					</button>
				</div>
				
				<div class="container-login100-form-btn p-t-10">
					<button onclick="window.location.href='quiz.php'" class="login100-form-btn">
						Quiz
					</button>
				</div>

				<div class="container-login100-form-btn p-t-10">
					<button onclick="window.location.href='leaderboard.php'" class="login100-form-btn">
						Leaderboard
					</button>
				</div>
